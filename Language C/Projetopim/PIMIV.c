...
void MostrarMenu(){
    ...
    getchar();    /* essa função é usada para liberar o '\n' que esta em buffer nesse momento*/
...
void CadastroPacientes(){
    ...
    do{
        ...
        if(cadastro == NULL){
            ...
            printf("TODOS OS DADOS DE: %s FORAM SALVOS COM SUCESSO!\n\n", nome);
...
void VerificaGrupoRisco(){
	...
	scanf("%i", &i);
		...
		switch (i){
			...
			case 1:
				fscanf(cadastro, "%100[^\n]s", nome);
				fprintf(grupo_risco, "O paciente %s possui a comorbidade: %i - Diabetes. Pertence ou Não pertence ao grupo de risco (acima de 65 anos) e Reside no CEP: .-*\n", nome, i);
				fclose(grupo_risco);
				fclose(cadastro);
			...
			case 2:
				...
				fprintf(grupo_risco, "O paciente * possui a comorbidade: %i - Obesidade. Pertence ao grupo de risco (acima de 65 anos) e Reside no CEP: *.-*\n", i);
				fclose(grupo_risco);
				printf("\nSalvo em arquivo com sucesso!\n");
				break;
			...
			case 3:
				...
				fprintf(grupo_risco, "O paciente * possui a comorbidade: %i - Hipertensao. Pertence ao grupo de risco (acima de 65 anos) e Reside no CEP: *.-*\n", i);
				fclose(grupo_risco);
				printf("\nSalvo em arquivo com sucesso!\n");
				break;
			...
			case 4:
				...
				fprintf(grupo_risco, "O paciente * possui a comorbidade: %i - Tuberculose. Pertence ao grupo de risco (acima de 65 anos) e Reside no CEP: *.-*\n", i);
				fclose(grupo_risco);
				printf("\nSalvo em arquivo com sucesso!\n");
				break;
			...
			case 5:
				...
				fprintf(grupo_risco, "O paciente * possui: Outros tipos de comorbidade. Pertence ao grupo de risco (acima de 65 anos) e Reside no CEP: *.-*\n", i);
				fclose(grupo_risco);
				printf("\nSalvo em arquivo com sucesso!\n");
				break;
